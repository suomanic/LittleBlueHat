...
func execute():
	...
	owner.global_position = lerp(owner.absolute_position,owner.character.current_absorb_bubble.global_position - Vector2(0,12),owner.absorbed_position_curve.interpolate(time))

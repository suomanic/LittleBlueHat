...
const AS_IdleState = preload("res://Actors/Player/AnimState/Idle.gd")
const AS_RunState = preload("res://Actors/Player/AnimState/Run.gd")
const AS_CrouchState = preload("res://Actors/Player/AnimState/Crouch.gd")
